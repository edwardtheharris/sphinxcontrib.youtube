...
<html lang="en">
  <head>
    ...
    <title>markdown-it-container &#8212; Sphinx Contrib YouTube 0.2.4 documentation</title>
...
<script>document.getElementById('searchbox').style.display = "block"</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../_sources/.venv/lib/python3.10/site-packages/mdit_py_plugins/container/README.md.txt"
